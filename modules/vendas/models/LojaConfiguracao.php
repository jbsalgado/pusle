...
class LojaConfiguracao extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['melhor_envio_token', 'melhor_envio_servicos'], 'string'],
            [['melhor_envio_cep_origem'], 'string', 'max' => 10],
            [['melhor_envio_acrescimo_dias'], 'integer', 'min' => 0, 'max' => 30],
            [['melhor_envio_acrescimo_valor'], 'number', 'min' => 0],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'cidade' => 'Cidade',
            'estado' => 'Estado',
            'melhor_envio_ativo' => 'Cálculo de Frete via Melhor Envio',
            'melhor_envio_ambiente' => 'Ambiente do Melhor Envio',
            'melhor_envio_token' => 'Token de Acesso (Bearer Token)',
            'melhor_envio_cep_origem' => 'CEP de Origem do Envio',
            'melhor_envio_servicos' => 'Serviços Habilitados',
            'melhor_envio_acrescimo_dias' => 'Prazo Adicional de Manuseio (Dias Úteis)',
            'melhor_envio_acrescimo_valor' => 'Taxa Adicional de Embalagem (R$)',
