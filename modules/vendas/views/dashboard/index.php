    ...
    <div class="bg-white rounded-lg shadow-sm p-4">
        <div class="flex items-center justify-between flex-wrap gap-3">
            <div class="flex items-center space-x-3">
                ...
                <a href="<?= Url::to(['/vendas/dashboard/executivo']) ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors duration-200 shadow-sm">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="overflow-x-auto">
                <?php if (empty($vendasRecentes)): ?>
                    <div class="text-center py-12">
                        ...
                        <p class="mt-2 text-gray-500">Nenhuma venda registrada</p>
                        <?= Html::a('Registrar primeira venda', Yii::getAlias('@web') . '/venda-direta/?token=' . $tokenJwt, ['class' => 'mt-4 inline-block px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700']) ?>
                    </div>
                <?php else: ?>
        ...
        <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <?= Html::a(
                    ...
                    Yii::getAlias('@web') . '/venda-direta/?token=' . $tokenJwt,
