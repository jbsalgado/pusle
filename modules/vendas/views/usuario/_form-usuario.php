...
<div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
        ...
        <?= Html::passwordInput('Usuario[senha]', '', [
            'id' => 'usuario-senha',
            'class' => 'w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
            'placeholder' => 'Mínimo 6 caracteres (deixe em branco para usuário já cadastrado)',
        ]) ?>
        <p class="mt-1 text-sm text-gray-500">A senha será mantida caso o CPF já exista no sistema.</p>
    </div>
    ...
    <div>
        ...
        <?= Html::passwordInput('Usuario[senha_confirmacao]', '', [
            ...
            'class' => 'w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
            'placeholder' => 'Digite a senha novamente se preencheu a senha',
        ]) ?>
