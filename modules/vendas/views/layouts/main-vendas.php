    ...
    <nav class="bg-white shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    <?= Html::a('📢 Marketing Social', ['/social-integration/index'], ['class' => 'text-purple-600 hover:text-purple-700 font-bold px-3 py-2 rounded-md bg-purple-50 hover:bg-purple-100 transition flex items-center gap-1.5']) ?>
        ...
        <div id="mobile-menu" class="hidden md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <?= Html::a('📢 Marketing Social', ['/social-integration/index'], ['class' => 'block px-3 py-2 rounded-md text-purple-600 font-bold bg-purple-50 hover:bg-purple-100']) ?>
