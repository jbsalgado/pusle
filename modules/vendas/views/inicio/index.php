...
$cards = [
    ...
    [
        'key' => 'modulo-prestanista',
        'grupo' => 'Ações Rápidas',
        'order' => 1.28,
        'label' => 'Vendas Prestanistas',
        'description' => 'Crediário ambulante, cartões e cobranças de rua',
        'color' => 'amber',
        'url' => ['/prestanista/default/index'],
        'badge' => 'Crediário Ambulante',
        'badge_bg' => 'bg-amber-300 text-gray-950 font-black',
        'icon_emoji' => '📇',
        'card_bg' => 'bg-gradient-to-br from-amber-600 via-orange-600 to-amber-700 text-white shadow-md',
    ],
    [
        'key' => 'nova-venda',
        'grupo' => 'Ações Rápidas',
    ...
    [
        'key' => 'whatsapp-bridge-local',
        'grupo' => 'Integrações',
        'order' => 6.25,
        'visible' => true,
        'label' => 'WhatsApp Local (Agent)',
        'url' => ['/vendas/bridge-whatsapp/index'],
        'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>',
        'color' => 'teal',
        'description' => 'Disparos via IP residencial da loja (Zero Custo)'
    ],
