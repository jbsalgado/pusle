                        ...
                        <div id="acesso_sistema_fields" class="mt-4" style="display: none;">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" disabled value="CPF do Colaborador" class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-500 text-sm sm:text-base cursor-not-allowed">
