                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            <strong>Dica:</strong> O valor inicial é o dinheiro físico presente no caixa no momento da abertura. Todas as movimentações serão registradas a partir deste valor.
                        </p>
                    </div>
                </div>
            </div>
