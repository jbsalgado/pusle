...
class SocialAccount extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return \app\modules\servicos\query\SocialAccountQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\servicos\query\SocialAccountQuery(get_called_class());
    }
}
