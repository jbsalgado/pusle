<?php
// Salve em: app/modules/indicadores/views/business-dashboard/farmacia.php
...
<div class="dashboard-index">
    <div class="dashboard-header">
        <h1 class="dashboard-title">Dashboard de Desempenho - Farmácia</h1>
        <p class="dashboard-subtitle">Principais KPIs do Segmento Farmacêutico</p>
    </div>
    ...
    <div class="metrics-grid">
        <?php if (!empty($dadosIndicadores)): ?>
            <?php foreach ($dadosIndicadores as $codigo => $data): ?>
                <?php
                if (empty($data['ultimoValor'])) continue;
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <div class="empty-state-message">Nenhum indicador encontrado para exibição</div>
            </div>
        <?php endif; ?>
    </div>
        ...
        <div class="charts-section">
            ...
            <div class="charts-grid">
                <?php foreach ($dadosIndicadores as $codigo => $data): ?>
                    ...
                    // O código aqui é exatamente o mesmo do seu `index.php` original.
                    // Cole a seção de gráficos aqui.
                    ?>
                <?php endforeach; ?>
            </div>
        </div>
