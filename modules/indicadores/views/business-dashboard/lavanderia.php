...
$this->title = 'Dashboard Lavanderia Industrial';
...
<div class="dashboard-index">
    <div class="dashboard-header">
        <h1 class="dashboard-title">Dashboard de Desempenho - Lavanderia Industrial</h1>
        <p class="dashboard-subtitle">Principais KPIs de Operação Industrial</p>
    </div>
