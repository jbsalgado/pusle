...
use app\modules\indicadores\models\AuthItemChild;

/**
 * AuthItemChildSearch represents the model behind the search form about `app\modules\indicadores\models\AuthItemChild`.
 */
