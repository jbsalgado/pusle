...
class ClienteController extends Controller
{
    ...
    // ===============================================
    // ✅ CORREÇÃO: ADICIONADO NOVO MÉTODO
    // ===============================================
    /**
    ...
    public function actionView($id)
    {
        ...
        if ($cliente) {
            // Retorna todos os campos do cliente (ou os necessários para o gateway)
            return $cliente->toArray([
                'id',
                'usuario_id',
                'nome_completo',
                'cpf', // O gateway Asaas pode usar 'cpf_cnpj'
                'cpf_cnpj' => $cliente->cpf, // Adicionando alias por segurança
                'telefone',
                'email',
                'endereco_logradouro',
                'logradouro' => $cliente->endereco_logradouro, // Alias
                'endereco_numero',
                'numero' => $cliente->endereco_numero, // Alias
                'endereco_complemento',
                'complemento' => $cliente->endereco_complemento, // Alias
                'endereco_bairro',
                'bairro' => $cliente->endereco_bairro, // Alias
                'endereco_cidade',
                'cidade' => $cliente->endereco_cidade, // Alias
                'endereco_estado',
                'estado' => $cliente->endereco_estado, // Alias
                'endereco_cep',
                'cep' => $cliente->endereco_cep, // Alias
            ]);
        } else {
