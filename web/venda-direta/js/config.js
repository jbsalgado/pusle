 ...
 * Remove /venda-direta ou /venda-direta/index do pathname e garante /index.php no final
 */
const detectApiBaseUrl = () => {
    const pathname = window.location.pathname;
    
    // Localiza a pasta /venda-direta para extrair o caminho base correto
    const idx = pathname.indexOf('/venda-direta');
...
export const API_ENDPOINTS = {
    ...
    MERCADOPAGO_CRIAR_PREFERENCIA_CARTEIRA: `${CONFIG.URL_API}/api/mercado-pago/criar-preferencia-carteira-digital`,
    MERCADOPAGO_CONSULTAR_STATUS_PREFERENCIA: `${CONFIG.URL_API}/api/mercado-pago/consultar-status-preferencia`,
